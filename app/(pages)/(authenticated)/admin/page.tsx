      ...
      <div className="mt-6 bg-white rounded-md p-4 shadow-custom mb-6">
        ...
        <div className="grid grid-col-span-1 md:grid-cols-4 gap-8">
          <div className="border rounded-md p-2 px-4 flex gap-4 items-center">
            ...
            <div>
              <div className="text-sm font-semibold">00 Empresas cadastradas</div>
          ...
          <div className="border rounded-md p-2 px-4 flex gap-4 items-center">
            ...
            <div>
              <div className="text-sm font-semibold">00 Novos users</div>
          ...
          <div className="border rounded-md p-2 px-4 flex gap-4 items-center">
            ...
            <div>
              <div className="text-sm font-semibold">00 Advogados cadastrados</div>
              <div className="text-xs text-gray-600">ver mais detalhes</div>
            </div>
          </div>
          ...
          <div className="border rounded-md p-2 px-4 flex gap-4 items-center">
            ...
            <div>
              <div className="text-sm font-semibold">00 Clientes cadastrados</div>
              <div className="text-xs text-gray-600">Ver mais detalhes</div>
            </div>
          </div>
        </div>
